...
import { DataService, Order, DepartmentType } from '../../services/data.service';
...
export class DashboardComponent {
  ...
  goToOrders(filter: string) {
    this.dataService.orderListFilter.set(filter as any);
    this.dataService.activeView.set('ORDERS');
  }
