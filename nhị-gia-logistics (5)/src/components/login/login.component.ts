    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <div class="mt-6 text-xs text-gray-500 bg-gray-50 p-2 rounded">
          ...
          <p class="cursor-pointer hover:text-blue-600" (click)="fill('Qlgiaonhan@nhigia.vn')">QL: Qlgiaonhan&#64;nhigia.vn</p>
          <p class="cursor-pointer hover:text-blue-600" (click)="fill('nvadmin@nhigia.vn')">Admin: nvadmin&#64;nhigia.vn</p>
          <p class="cursor-pointer hover:text-blue-600" (click)="fill('nvgiaonhan1@nhigia.vn')">Shipper: nvgiaonhan1&#64;nhigia.vn</p>
          <p class="cursor-pointer hover:text-blue-600 font-bold" (click)="fill('it@nhigia.vn')">IT Admin: it&#64;nhigia.vn</p>
        </div>
      </div>
    </div>
  `
