...
import { DepartmentType, FilterType, LocationData, Order, OrderStatus } from '../../type/models';
...
export class OrderListComponent {
  ...
  completeJob() {
    ...
    this.closeAction();
    this.orderService.shipperComplete(o.id, imgs, loc, this.mockSignature, this.actionNote || 'Đã xong');
  }
  ...
  onDrop(event: CdkDragDrop<Order[]>) {
    ...
    this.orderService.updateOrderSort(this.authService.currentUser()?.email || 'unknown', orderIds);
  }
