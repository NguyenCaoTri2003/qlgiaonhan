              ...
              <tr class="hover:bg-gray-50">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                  <span
                    ...
                    [ngClass]="getActionConfig(log.action).color"
                  >
...
export class ActivityLogComponent {
  ...
  actionMap: Record<string, { label: string; color: string }> = {
    CREATE: {
      label: "Tạo đơn mới",
    ...
    SHIPPER_REJECTED: {
      label: "Shipper từ chối",
      color: "bg-red-100 text-red-800",
    },
    SHIPPER_COMPLETE: {
      label: "Shipper hoàn thành",
